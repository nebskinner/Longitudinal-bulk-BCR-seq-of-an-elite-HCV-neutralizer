...
seq_df <- read.table("/home/gdskinnerlab/nes002/serial_timepoints_C110/CDR3_alignment/CDR3_sequences_IGH/AR1_bnab_IGH.txt", sep = "\t", header=TRUE)
...
write.csv(homol_seq, "/home/gdskinnerlab/nes002/serial_timepoints_C110/scripts/AR1_bnab_align_IGH.csv")  
