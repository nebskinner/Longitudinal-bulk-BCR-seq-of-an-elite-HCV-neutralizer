...
seq_df <- read.table("/home/gdskinnerlab/nes002/serial_timepoints_C110/CDR3_alignment/CDR3_sequences_IGH/E2n_AR24_filt_IGH.txt", sep = "\t", header=TRUE)
...
write.csv(homol_seq, "/home/gdskinnerlab/nes002/serial_timepoints_C110/scripts/E2n_AR24_align_IGH.csv")
