...
seq_df_E2n <- read.table("/home/gdskinnerlab/nes002/serial_timepoints_C110/CDR3_alignment/CDR3_sequences_IGH/E2n_frly_filt_IGH.txt", sep = "\t", header=TRUE)

CDR3_sequences <- seq_df_E2n$CDR3_aa
...
write.csv(homol_seq, "/home/gdskinnerlab/nes002/serial_timepoints_C110/CDR3_alignment/CDR3_alignments_IGH/E2neg_frly_IGH_align/E2neg_frly_IGH_alignment_sep.csv")  


#### bnabs
## load sequences to be aligned
seq_df_bnab <- read.table("/home/gdskinnerlab/nes002/serial_timepoints_C110/CDR3_alignment/CDR3_sequences_IGH/frly_bnab_IGH.txt", sep = "\t", header=TRUE)

CDR3_sequences <- seq_df_bnab$CDR3_aa
...
homol_seq <- rbind.data.frame(data.frame(Seq = homol_order$Comp_seq[1], Avg_homol = NA), homol_seq, stringsAsFactors = FALSE)
write.csv(homol_seq, "/home/gdskinnerlab/nes002/serial_timepoints_C110/CDR3_alignment/CDR3_alignments_IGH/E2neg_frly_IGH_align/frly_bnab_alignment.csv")  
