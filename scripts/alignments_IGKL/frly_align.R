...
seq_df  <- read.table("/home/gdskinnerlab/nes002/serial_timepoints_C110/CDR3_alignment/CDR3_sequences_IGKL/frly_bnab_IGKL.txt", sep = "\t", header=TRUE)
...
write.csv(homol_seq, "/home/gdskinnerlab/nes002/serial_timepoints_C110/CDR3_alignment/CDR3_alignments_IGKL/frly_bnab_align_IGKL.csv")  
